...
export default function ExperienceLayout({ children }) {
  return (
    <div style={{ background: '#0B2935' }}>
      ...
      <nav style={{ position: 'fixed', bottom: 'calc(14px + env(safe-area-inset-bottom, 0px))', left: '50%', transform: 'translateX(-50%)', zIndex: 60, display: 'flex', gap: '4px', padding: '5px', borderRadius: '9999px', background: 'rgba(11,41,53,.88)', border: '1px solid rgba(255,255,255,.14)', backdropFilter: 'blur(8px)', boxShadow: 'var(--shadow-lg)' }}>
